...
extern "C" {
    ...
    #[doc = "   <br> When an occupied exclusive mode device is chosen with ::cudaSetDevice,"]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " - ::cudaDevAttrDeferredMappingCudaArraySupported : 1 if the device supports deferred mapping CUDA arrays and CUDA mipmapped arrays."]
    #[doc = ""]
    #[doc = ""]
...
extern "C" {
    ...
    #[doc = " will be associated with the primary context. This function will not initialize"]
    #[doc = " the context until a runtime API requiring the context (such as ::cudaMalloc())"]
    #[doc = " is used. This function will not return an error if the device is in"]
    #[doc = " ::cudaComputeModeExclusiveProcess and is occupied by another process or"]
    #[doc = " if the device is in ::cudaComputeModeProhibited."]
    #[doc = ""]
...
extern "C" {
    ...
    #[doc = "   can later be mapped onto a physical memory allocation by calling ::cuMemMapArrayAsync."]
    #[doc = "   The physical backing memory must be allocated via ::cuMemCreate."]
    #[doc = ""]
    #[doc = " - ::cudaArrayDeferredMapping: Allocates a CUDA array without physical backing memory. The entire array can"]
    #[doc = "   later be mapped onto a physical memory allocation by calling ::cuMemMapArrayAsync."]
    #[doc = "   The physical backing memory must be allocated via ::cuMemCreate."]
    #[doc = ""]
    #[doc = ""]
...
extern "C" {
    ...
    #[doc = " returned by a previous call to one of the following memory allocation APIs -"]
    #[doc = " ::cudaMalloc(), ::cudaMallocPitch(), ::cudaMallocManaged(), ::cudaMallocAsync(),"]
    #[doc = " ::cudaMallocFromPoolAsync()."]
    #[doc = ""]
    #[doc = " Note - This API will not perform any implicit synchronization when the pointer was"]
    #[doc = " allocated with ::cudaMallocAsync or ::cudaMallocFromPoolAsync. Callers must ensure"]
    #[doc = " that all accesses to the pointer have completed before invoking ::cudaFree. For"]
    #[doc = " best performance and memory reuse, users should use ::cudaFreeAsync to free memory"]
    #[doc = " allocated via the stream ordered memory allocator."]
    #[doc = ""]
    #[doc = " If ::cudaFree(\\p devPtr) has already been called before,"]
    ...
    #[doc = " \\note_callback"]
    #[doc = ""]
    #[doc = " \\sa ::cudaMalloc, ::cudaMallocPitch, ::cudaMallocManaged, ::cudaMallocArray, ::cudaFreeArray, ::cudaMallocAsync, ::cudaMallocFromPoolAsync"]
    #[doc = " \\ref ::cudaMallocHost(void**, size_t) \"cudaMallocHost (C API)\","]
    #[doc = " ::cudaFreeHost, ::cudaMalloc3D, ::cudaMalloc3DArray, ::cudaFreeAsync"]
    #[doc = " ::cudaHostAlloc,"]
    #[doc = " ::cuMemFree"]
...
extern "C" {
    ...
    #[doc = " - ::cudaArraySparse: Allocates a CUDA array without physical backing memory. The subregions within this sparse array"]
    #[doc = "   can later be mapped onto a physical memory allocation by calling ::cuMemMapArrayAsync. This flag can only be used for"]
    #[doc = "   creating 2D, 3D or 2D layered sparse CUDA arrays. The physical backing memory must be allocated via ::cuMemCreate."]
    #[doc = ""]
    #[doc = " - ::cudaArrayDeferredMapping: Allocates a CUDA array without physical backing memory. The entire array can"]
    #[doc = "   later be mapped onto a physical memory allocation by calling ::cuMemMapArrayAsync. The physical backing memory must be allocated"]
    #[doc = "   via ::cuMemCreate."]
    #[doc = ""]
    #[doc = ""]
...
extern "C" {
    ...
    #[doc = " - ::cudaArraySparse: Allocates a CUDA mipmapped array without physical backing memory. The subregions within this sparse array"]
    #[doc = "   can later be mapped onto a physical memory allocation by calling ::cuMemMapArrayAsync. This flag can only be used for creating"]
    #[doc = "   2D, 3D or 2D layered sparse CUDA mipmapped arrays. The physical backing memory must be allocated via ::cuMemCreate."]
    #[doc = ""]
    #[doc = " - ::cudaArrayDeferredMapping: Allocates a CUDA mipmapped array without physical backing memory. The entire array can"]
    #[doc = "   later be mapped onto a physical memory allocation by calling ::cuMemMapArrayAsync. The physical backing memory must be allocated"]
    #[doc = "   via ::cuMemCreate."]
    #[doc = ""]
    #[doc = ""]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " Returns in \\p *total the total amount of memory available to the the current context."]
    ...
    #[doc = " In a multi-tenet situation, free estimate returned is prone to race condition where"]
    #[doc = " a new allocation/free done by a different process or a different thread in the same"]
    #[doc = " process between the time when free memory was estimated and reported, will result in"]
    #[doc = " deviation in free value reported and actual free memory."]
    #[doc = ""]
    #[doc = " The integrated GPU on Tegra shares memory with CPU and other component"]
    #[doc = " of the SoC. The free and total values returned by the API excludes"]
    #[doc = " the SWAP memory space maintained by the OS on some platforms."]
    #[doc = " The OS may move some of the memory pages into swap area as the GPU or"]
    #[doc = " CPU allocate or access memory. See Tegra app note on how to calculate"]
    #[doc = " total and free memory on Tegra."]
    #[doc = ""]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " Returns the memory requirements of a CUDA array in \\p memoryRequirements"]
    #[doc = " If the CUDA array is not allocated with flag ::cudaArrayDeferredMapping"]
    #[doc = " ::cudaErrorInvalidValue will be returned."]
    #[doc = ""]
    #[doc = " The returned value in ::cudaArrayMemoryRequirements::size"]
    #[doc = " represents the total size of the CUDA array."]
    #[doc = " The returned value in ::cudaArrayMemoryRequirements::alignment"]
    #[doc = " represents the alignment necessary for mapping the CUDA array."]
    #[doc = ""]
    #[doc = " \\return"]
    #[doc = " ::cudaSuccess"]
    #[doc = " ::cudaErrorInvalidValue"]
    #[doc = ""]
    #[doc = " \\param[out] memoryRequirements - Pointer to ::cudaArrayMemoryRequirements"]
    #[doc = " \\param[in] array - CUDA array to get the memory requirements of"]
    #[doc = " \\param[in] device - Device to get the memory requirements for"]
    #[doc = " \\sa ::cudaMipmappedArrayGetMemoryRequirements"]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " Returns the memory requirements of a CUDA mipmapped array in \\p memoryRequirements"]
    #[doc = " If the CUDA mipmapped array is not allocated with flag ::cudaArrayDeferredMapping"]
    #[doc = " ::cudaErrorInvalidValue will be returned."]
    #[doc = ""]
    #[doc = " The returned value in ::cudaArrayMemoryRequirements::size"]
    #[doc = " represents the total size of the CUDA mipmapped array."]
    #[doc = " The returned value in ::cudaArrayMemoryRequirements::alignment"]
    #[doc = " represents the alignment necessary for mapping the CUDA mipmapped"]
    #[doc = " array."]
    #[doc = ""]
    #[doc = " \\return"]
    #[doc = " ::cudaSuccess"]
    ...
    #[doc = ""]
    #[doc = " \\param[out] memoryRequirements - Pointer to ::cudaArrayMemoryRequirements"]
    #[doc = " \\param[in] mipmap - CUDA mipmapped array to get the memory requirements of"]
    #[doc = " \\param[in] device - Device to get the memory requirements for"]
    #[doc = " \\sa ::cudaArrayGetMemoryRequirements"]
...
extern "C" {
    ...
    #[doc = " - ::cudaMemPoolAttrReservedMemHigh: (value type = cuuint64_t)"]
    ...
    #[doc = " - ::cudaMemPoolAttrUsedMemHigh: (value type = cuuint64_t)"]
...
extern "C" {
    ...
    #[doc = "                    in order to establish the stream ordering required to reuse"]
    #[doc = "                    a piece of memory released by ::cudaFreeAsync (default enabled)."]
    #[doc = " - ::cudaMemPoolAttrReservedMemCurrent: (value type = cuuint64_t)"]
    #[doc = "                    Amount of backing memory currently allocated for the mempool."]
    #[doc = " - ::cudaMemPoolAttrReservedMemHigh: (value type = cuuint64_t)"]
    #[doc = "                    High watermark of backing memory allocated for the mempool since"]
    #[doc = "                    the last time it was reset."]
    #[doc = " - ::cudaMemPoolAttrUsedMemCurrent: (value type = cuuint64_t)"]
    #[doc = "                    Amount of memory from the pool that is currently in use by the application."]
    #[doc = " - ::cudaMemPoolAttrUsedMemHigh: (value type = cuuint64_t)"]
    #[doc = "                    High watermark of the amount of memory from the pool that was in use by the"]
    #[doc = "                    application since the last time it was reset."]
    #[doc = ""]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " - ::cudaTextureDesc::seamlessCubemap specifies whether seamless cube map filtering is enabled. This flag can only be specified if the"]
    #[doc = "   underlying resource is a CUDA array or a CUDA mipmapped array that was created with the flag ::cudaArrayCubemap."]
    #[doc = "   When seamless cube map filtering is enabled, texture address modes specified by ::cudaTextureDesc::addressMode are ignored."]
    #[doc = "   Instead, if the ::cudaTextureDesc::filterMode is set to ::cudaFilterModePoint the address mode ::cudaAddressModeClamp will be applied for all dimensions."]
    #[doc = "   If the ::cudaTextureDesc::filterMode is set to ::cudaFilterModeLinear seamless cube map filtering will be performed when sampling along the cube face borders."]
    #[doc = ""]
...
extern "C" {
    ...
    #[doc = "   - A cooperative node cannot be updated to a non-cooperative node, and vice-versa."]
    #[doc = "   - If the graph was instantiated with cudaGraphInstantiateFlagUseNodePriority, the"]
    #[doc = "     priority attribute cannot change. Equality is checked on the originally requested"]
    #[doc = "     priority values, before they are clamped to the device's supported range."]
    ...
    #[doc = " - cudaGraphExecUpdateErrorAttributesChanged if any attributes of a node changed in a way"]
    #[doc = "   that is not supported, in which case \\p hErrorNode_out is set to the node from \\p hGraph"]
